...
// in crypto_tracker_app/test/domain/usecases/get_coins_list_test.dart.
...
/// A class which mocks [CoinsListRepository].
///
/// See the documentation for Mockito's code generation for more information.
class MockCoinsListRepository<T> extends _i1.Mock
    implements _i3.CoinsListRepository<T> {
  MockCoinsListRepository() {
