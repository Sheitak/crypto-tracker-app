...
class _BuildBodyListCoinsWidget extends ConsumerWidget {
  ...
  //   final coinIsFavorite = ref.watch(updateFavoritesController);
  //   return ListView.builder(
  //       itemBuilder: (context, index) {
  //     return FavoritesWidget(coinIsFavorite[index]);
  //   },
  //   itemCount: coinIsFavorite.length,
  //   );
  // }

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    return ref.watch(favoriteCoinsListViewModelProvider).when(
        data: (either) {
          return either.fold(
